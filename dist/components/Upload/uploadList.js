...
export var UploadList = function (props) {
    ...
    return (React.createElement("ul", { className: "difing-upload-list" }, fileList.map(function (item) {
        return (React.createElement("li", { className: "difing-upload-list-item", key: item.uid },
