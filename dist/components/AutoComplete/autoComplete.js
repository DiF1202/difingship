...
export var AutoComplete = function (props) {
    ...
    var renderTemplate = function (item) {
        return renderOption ? renderOption(item) : item === null || item === void 0 ? void 0 : item.value;
    };
    var generateDropdown = function () {
        return (React.createElement(Transition, { in: showDropdown || loading, animation: "zoom-in-top", timeout: 300, onExited: function () {
                setSuggestions([]);
            } },
            React.createElement("ul", { className: "difing-suggestion-list" },
    ...
    return (React.createElement("div", { className: "difing-auto-complete", ref: componentRef },
